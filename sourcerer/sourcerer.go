...
var (
	...
	targetNameArg   = command.OptionalArg[string]("TARGET_NAME", "The name of the created target in $GOPATH/bin", command.Default("leep-frog-source"), command.MatchesRegex("^[a-zA-Z]+$"))
