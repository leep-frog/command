				...
				osChecks: map[string]*osCheck{
					osLinux: {
						wantStdout: []string{
							...
							`}`,
							``,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_for_alias_a1 -o nosort a1) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							``,
							...
							`}`,
							``,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_for_alias_otherAlias -o nosort otherAlias) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							``,
							`}`, // wrap function end bracket
							`_leepFrogSource_wrap_function`,
							``,
				...
				osChecks: map[string]*osCheck{
					osLinux: {
						wantStdout: []string{
							...
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogSource -o nosort basic) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`alias l='_custom_execute_leepFrogSource l'`,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogSource -o nosort l) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							"alias x='_custom_execute_leepFrogSource x'",
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogSource -o nosort x) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`}`, // wrap function end bracket
							`_leepFrogSource_wrap_function`,
							``,
						},
				...
				osChecks: map[string]*osCheck{
					osLinux: {
						wantStdout: []string{
							...
							``,
							`alias basic='o=$(mktemp) && _setup_for_basic_cli > $o && _custom_execute_leepFrogSource basic $o'`,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogSource  basic) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`alias l='_custom_execute_leepFrogSource l'`,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogSource  l) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							"alias x='_custom_execute_leepFrogSource x'",
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogSource  x) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`}`, // wrap function end bracket
							`_leepFrogSource_wrap_function`,
							``,
						},
				...
				osChecks: map[string]*osCheck{
					osLinux: {
						wantStdout: []string{
							...
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogBuiltIns -o nosort aliaser) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`alias gg='_custom_execute_leepFrogBuiltIns gg'`,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogBuiltIns -o nosort gg) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`alias goleep='_custom_execute_leepFrogBuiltIns goleep'`,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogBuiltIns -o nosort goleep) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`alias leep_debug='_custom_execute_leepFrogBuiltIns leep_debug'`,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogBuiltIns -o nosort leep_debug) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`alias sourcerer='_custom_execute_leepFrogBuiltIns sourcerer'`,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_leepFrogBuiltIns -o nosort sourcerer) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`}`, // wrap function end bracket
				...
				osChecks: map[string]*osCheck{
					osLinux: {
						wantStdout: []string{
							...
							`}`,
							``,
							fmt.Sprintf(`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_RunCLI%s -o nosort %s) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`, exeBaseName, exeBaseName),
							`}`,
				...
				osChecks: map[string]*osCheck{
					osLinux: {
						wantStdout: []string{
							...
							`}`,
							``,
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_RunCLIabc -o nosort abc) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							`}`,
				...
				osChecks: map[string]*osCheck{
					osLinux: {
						wantFileContents: []string{
							...
							"}",
							"",
							`((type complete > /dev/null 2>&1) && complete -F _custom_autocomplete_for_alias_bleh -o nosort bleh) || (echo 'shell function "complete" either failed or does not exist; if using zsh, be sure to set up bashcompinit')`,
							"",
						},
					},
					osWindows: {
