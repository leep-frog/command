...
func execute(n Node, input *Input, output Output, data *Data) (eData *ExecuteData, retErr error) {
	eData = &ExecuteData{}
	return eData, commander.Execute[*Input, Output, *Data, *ExecuteData, *Completion, *Usage, Node](n, input, output, data, eData, efb)
}
...
func processOrExecute(p Processor, input *Input, output Output, data *Data, eData *ExecuteData) error {
	return commander.ProcessOrExecute[*Input, Output, *Data, *ExecuteData, *Completion, *Usage, Node](p, input, output, data, eData)
}
...
func processGraphExecution(root Node, input *Input, output Output, data *Data, eData *ExecuteData) error {
	return commander.ProcessGraphExecution[*Input, Output, *Data, *ExecuteData, *Completion, *Usage, Node](root, input, output, data, eData)
}
